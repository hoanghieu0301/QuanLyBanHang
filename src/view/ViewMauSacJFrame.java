 ...
 * @author ASUS
 */
public class ViewMauSacJFrame extends javax.swing.JFrame {
    ...
    public ViewMauSacJFrame() {
        ...
        listQLMauSac = mauSacService.selectAll();
        showData(listQLMauSac);
    }

    private void fillData(int index) {
        lblId.setText(listQLMauSac.get(index).getId());
        txtMa.setText(listQLMauSac.get(index).getMa());
        txtTen.setText(listQLMauSac.get(index).getTen());
    }

    private void showData(List<QLMauSac> listQLMauSac) {
        dtm.setRowCount(0);
        for (QLMauSac ql : listQLMauSac) {
    ...
    private void btnThemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnThemActionPerformed
        JOptionPane.showMessageDialog(this, mauSacService.addMauSac(new QLMauSac(txtMa.getText(), txtTen.getText())));
        showData(listQLMauSac);
    ...
    private void btnSuaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSuaActionPerformed
        ...
        if (index != -1) {
            String id = listQLMauSac.get(index).getId();
            JOptionPane.showMessageDialog(this, mauSacService.updateMauSac(new QLMauSac(txtMa.getText(), txtTen.getText()), id));
            listQLMauSac = mauSacService.selectAll();
            showData(listQLMauSac);
        } else {
    ...
    private void btnXoaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnXoaActionPerformed
        index = jTable1.getSelectedRow();
        if (index != -1) {
            JOptionPane.showMessageDialog(this, mauSacService.deleteMauSac(listQLMauSac.get(index).getId()));
            listQLMauSac = mauSacService.selectAll();
            showData(listQLMauSac);
        } else {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ViewMauSacJFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ViewMauSacJFrame().setVisible(true);
            }
        });
    }
